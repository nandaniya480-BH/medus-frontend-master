...
const UserProfileResume = () => {
  const { data, isLoading: isUserLoading } = useGetUserDetailsQuery();
  ...
  return (
    <>
      <Page>
        <PageContent>
          <div className="w-full bg-radial-gradient">
            <div className="container mx-auto md:p-0 p-4 mt-10 mb-4">
              <div className="md:w-10/12 w-full flex flex-row justify-between mx-auto">
                <Link
                  to={'/user/profile'}
            ...
            <div
              id="resume-template"
              className="container mx-auto mb-10 md:p-0 p-4"
            >
              <div className="md:w-10/12 bg-white w-full flex flex-col mx-auto shadow-lg rounded-lg drop-shadow-[0_5px_15px_rgba(0,0,0,0.25)]">
                <div id="resume-template" className="flex flex-col gap-8">
                  ...
                  <div className="w-full flex flex-col text-blueGray-700 px-4">
                    <h5 className="mt-4 text-2xl font-bold mb-2">
                      <i className="fa-solid fa-circle-info"></i> Mein kurz
                      Profil
                    </h5>
                    {!isUserLoading ? (
                      ...
                      <>
                        ...
                        >
                          ...
                          {user?.contract_types?.length > 0
                            ? user?.contract_types?.map((item, index) => (
                        ...
                        >
                          ...
                          {user?.job_sub_categories?.length > 0
                            ? user?.job_sub_categories?.map((item, index) => (
                                <span key={index} className=" mr-1">
                                  ● {item?.name}
                                </span>
                              ))
                      ...
                      {!isUserLoading ? (
                        user?.soft_skills?.length ? (
                          user.soft_skills.map((item, index) => (
                            <span key={index} className="py-[0.5px] px-2">
                              # {item?.name}
                            </span>
                          ))
                        ) : (
